<%@ Page Language="C#" AutoEventWireup="true" CodeFile="register.aspx.cs" Inherits="register2" %>
<html>
...
<script type ="text/javascript">
    ...
    function Check() {
        return (checkEmail() && checkFName() && checkLName() && checkPsw() && repPsw() && checkUName())
    }
...
<form id = "signUp" action="" method="post" name = "signUp" onsubmit = "return Check()">
...
<div id = "uNameD"></div>
<input type = "text" id = "uName" name = "uName" placeholder = "Enter Userame" onblur = "checkUName()"/>   <%=userExists%><br />
...
<p>Already have an account?</p><button onclick= "logIn()">Log In</button>
</body>
